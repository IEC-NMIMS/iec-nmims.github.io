        ...
        <LearnBox>
          <LearnImageBox>
            <InsightsIcon
              sx={{
                fontSize:
                  isMobile && window.innerWidth < 1024 ? "6rem" : "9rem",
                zIndex: "1",
              }}
            />
          </LearnImageBox>
          <LearnContentBox>
            <LearnTitle>
              Broaden your understanding of the corporate world
            </LearnTitle>
            <LearnDescription>
              IEC's introductory event meant for freshers essentially to get the
              essence of 'our vision and mission'.It is a delightful experience
              with a Bollywood twist where freshers get hands-on experience
